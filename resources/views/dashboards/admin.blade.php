                    ...
                    <div class="col-xxl-4 col-sm-6">
                        <div class="card shadow-1 radius-8 gradient-bg-end-1 h-100">
                            <div class="card-body p-20">
                                ...
                                <a href="{{ route('home-intro.edit') }}" class="my-sidebar-btn btn btn-primary-600 d-flex align-items-center gap-6">
    Admin View
</a>
                    ...
                    <div class="col-xxl-4 col-sm-6">
                        <div class="card shadow-1 radius-8 gradient-bg-end-2 h-100">
                            <div class="card-body p-20">
                                ...
                                <div class="d-flex gap-2">
                                <a href="{{ route('news-posts.index') }}" class="my-sidebar-btn btn btn-primary-600 d-flex align-items-center gap-6">
                                    Admin View
                                </a>
