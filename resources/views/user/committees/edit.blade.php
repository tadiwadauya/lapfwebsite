...
<div class="dashboard-main-body">
    ...
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h6 class="fw-semibold mb-0">Edit Committee</h6>
            <p class="text-neutral-600 mt-4 mb-0">Dashboard / Governance / Committees / Edit</p>
        </div>
    ...
    <div class="card shadow-1 radius-12 bg-base">
        <div class="card-body p-24">
            ...
            <form method="POST" action="{{ route('user.committees.update', $committee) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-xl-2 col-sm-6 d-flex align-items-center">
                        <div class="form-check mt-24">
                            <input class="form-check-input"
                                   ...
                                   value="1"
                                   id="is_active"
                                   {{ old('is_active', $committee->is_active) ? 'checked' : '' }}>
