...
<div class="container">
    <h3 class="mb-3">Upload Active Member Images descriptions</h3>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('user.active-members.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <small class="text-muted">You can select many images at once.</small>
                    </div>
                </div>
