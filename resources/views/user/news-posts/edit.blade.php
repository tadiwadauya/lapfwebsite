...
<div class="dashboard-main-body">
    ...
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h6 class="fw-semibold mb-0">Edit News Post</h6>
            <p class="text-neutral-600 mt-4 mb-0">Dashboard / News / Edit</p>
        </div>
    </div>
    ...
    <div class="card shadow-1 radius-12 bg-base">
        <div class="card-body p-24">
            ...
            <form method="POST" action="{{ route('user.news-posts.update', $post) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                @include('user.news-posts.partials.form', ['post' => $post])

                <div class="d-flex justify-content-end mt-20">
                    <button class="btn btn-primary-600">Update Post</button>
                </div>
            </form>
